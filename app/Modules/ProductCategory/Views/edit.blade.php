...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <span class="card-title"><i class="fa fa-edit"></i> Product Category Edit</span>
                </div><!--col-->
            </div>
        </div>
        {!! Form::open(['route'=>array('product-categories.update',\App\Libraries\Encryption::encodeId($productCategory->id)),'method'=>'patch','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
...
@section('footer-script')
    <script type="text/javascript">
        /******************************
         FRONTEND VALIDATION START HERE
         ****************************/
        ...
        $(document.body).on('click','.action-delete',function(ev){
            ...
            let redirectURL = "{{ route('product-categories.edit',\App\Libraries\Encryption::encodeId($productCategory->id)) }}";
